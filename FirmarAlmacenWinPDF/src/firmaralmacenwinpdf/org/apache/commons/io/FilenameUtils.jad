...
public class FilenameUtils
{
    ...
    private static String doNormalize(String filename, char separator, boolean keepSeparator)
    {
        ...
        char otherSeparator = separator != SYSTEM_SEPARATOR ? SYSTEM_SEPARATOR : OTHER_SEPARATOR;
...
label0:
    ...
    public static String concat(String basePath, String fullFilenameToAdd)
    {
        ...
        if(isSeparator(ch))
            ...
            return normalize((new StringBuilder()).append(basePath).append('/').append(fullFilenameToAdd).toString());
    }
    ...
    public static int getPrefixLength(String filename)
    {
        ...
        if(ch0 == '~')
        {
            ...
            {
                posUnix = posUnix != -1 ? posUnix : posWin;
                posWin = posWin != -1 ? posWin : posUnix;
    ...
    public static String getPrefix(String filename)
    {
        ...
        if(len > filename.length())
            return (new StringBuilder()).append(filename).append('/').toString();
        else
    ...
    static String[] splitOnTokens(String text)
    {
        ...
        for(int i = 0; i < array.length; i++)
            if(array[i] == '?' || array[i] == '*')
            {
                ...
                if(list.isEmpty() || i > 0 && !((String)list.get(list.size() - 1)).equals("*"))
                    list.add("*");
            } else
            {
