...
private class JcaX509CertificateConverter$ExCertificateException extends CertificateException
{
    ...
    public JcaX509CertificateConverter$ExCertificateException(String msg, Throwable cause)
    {
