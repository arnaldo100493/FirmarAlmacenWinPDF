...
// Source File Name:   DefaultCMSSignatureAlgorithmNameGenerator.java
    ...
    implements CMSSignatureAlgorithmNameGenerator
{
    ...
    {
        return (new StringBuilder()).append(getDigestAlgName(digestAlg.getAlgorithm())).append("with").append(getEncryptionAlgName(encryptionAlg.getAlgorithm())).toString();
    }
