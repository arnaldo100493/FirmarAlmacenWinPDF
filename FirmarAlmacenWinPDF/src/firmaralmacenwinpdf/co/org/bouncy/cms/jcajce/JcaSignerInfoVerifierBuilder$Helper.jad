...
private class JcaSignerInfoVerifierBuilder$Helper
{
    ...
    private JcaSignerInfoVerifierBuilder$Helper()
    {
        this$0 = JcaSignerInfoVerifierBuilder.this;
        super();
    }

    JcaSignerInfoVerifierBuilder$Helper(JcaSignerInfoVerifierBuilder._cls1 x1)
    {
        this();
    }
}
