...
class JcePKCSPBEInputDecryptorProviderBuilder$1$1
    implements InputDecryptor
{
    ...
    JcePKCSPBEInputDecryptorProviderBuilder$1$1()
    {
        this$1 = JcePKCSPBEInputDecryptorProviderBuilder._cls1.this;
        super();
    }

    // Unreferenced inner class co/org/bouncy/pkcs/jcajce/JcePKCSPBEInputDecryptorProviderBuilder$1

/* anonymous class */
    class JcePKCSPBEInputDecryptorProviderBuilder._cls1
            ...
            throws OperatorCreationException
        {
            ...
            try
            {
                ...
                if(algorithm.equals(PKCSObjectIdentifiers.id_PBES2))
                {
                    ...
                    key = keyFact.generateSecret(new PBEKeySpec(password, func.getSalt(), func.getIterationCount().intValue(), JcePKCSPBEInputDecryptorProviderBuilder.access$200(JcePKCSPBEInputDecryptorProviderBuilder.this).getKeySize(encScheme)));
            ...
            return new JcePKCSPBEInputDecryptorProviderBuilder._cls1._cls1();
        }
