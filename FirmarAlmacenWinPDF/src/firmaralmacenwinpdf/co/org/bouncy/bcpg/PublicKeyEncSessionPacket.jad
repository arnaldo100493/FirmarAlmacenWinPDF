...
// Source File Name:   PublicKeyEncSessionPacket.java
...
//            ContainedPacket, MPInteger, BCPGOutputStream, PublicKeyAlgorithmTags, 
//            BCPGInputStream
    ...
    implements PublicKeyAlgorithmTags
{
    ...
    PublicKeyEncSessionPacket(BCPGInputStream in)
        throws IOException
    {
        version = in.read();
