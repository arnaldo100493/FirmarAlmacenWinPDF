...
private static class SP800SecureRandomBuilder$DualECDRBGProvider
    implements DRBGProvider
{
    ...
    public SP800SecureRandomBuilder$DualECDRBGProvider(Digest digest, byte nonce[], byte personalizationString[], int securityStrength)
    {
        this.digest = digest;
        this.nonce = nonce;
