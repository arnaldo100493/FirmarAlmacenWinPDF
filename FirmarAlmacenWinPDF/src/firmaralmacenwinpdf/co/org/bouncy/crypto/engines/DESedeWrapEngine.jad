...
// Source File Name:   DESedeWrapEngine.java
    ...
    implements Wrapper
{
        ...
        throws InvalidCipherTextException
    {
        ...
        if(inLen % blockSize != 0)
            throw new InvalidCipherTextException((new StringBuilder()).append("Ciphertext not multiple of ").append(blockSize).toString());
        ParametersWithIV param2 = new ParametersWithIV(param, IV2);
