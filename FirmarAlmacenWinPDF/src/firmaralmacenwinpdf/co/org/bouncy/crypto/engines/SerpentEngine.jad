...
// Source File Name:   SerpentEngine.java
    ...
    implements BlockCipher
{
    ...
    public void init(boolean encrypting, CipherParameters params)
    {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder()).append("invalid parameter passed to Serpent init - ").append(params.getClass().getName()).toString());
        }
    }
