...
// Source File Name:   BlowfishEngine.java
    ...
    implements BlockCipher
{
    ...
    public void init(boolean encrypting, CipherParameters params)
    {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder()).append("invalid parameter passed to Blowfish init - ").append(params.getClass().getName()).toString());
        }
    }
