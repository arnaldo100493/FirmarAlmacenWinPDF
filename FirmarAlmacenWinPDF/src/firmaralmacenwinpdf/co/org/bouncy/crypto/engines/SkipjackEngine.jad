...
// Source File Name:   SkipjackEngine.java
    ...
    implements BlockCipher
{
    ...
    public void init(boolean encrypting, CipherParameters params)
    {
        if(!(params instanceof KeyParameter))
            throw new IllegalArgumentException((new StringBuilder()).append("invalid parameter passed to SKIPJACK init - ").append(params.getClass().getName()).toString());
