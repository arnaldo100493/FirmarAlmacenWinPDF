...
// Source File Name:   RC2WrapEngine.java
    ...
    implements Wrapper
{
        ...
        throws InvalidCipherTextException
    {
        ...
        {
            throw new InvalidCipherTextException((new StringBuilder()).append("too many pad bytes (").append(result.length - ((result[0] & 0xff) + 1)).append(")").toString());
        } else
        {
