...
public static class McElieceFujisakiCipherSpi$McElieceFujisaki384 extends McElieceFujisakiCipherSpi
{

    public McElieceFujisakiCipherSpi$McElieceFujisaki384()
    {
