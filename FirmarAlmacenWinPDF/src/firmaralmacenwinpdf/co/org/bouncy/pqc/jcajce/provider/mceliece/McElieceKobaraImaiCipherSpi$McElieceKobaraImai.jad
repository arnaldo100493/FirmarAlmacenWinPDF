...
public static class McElieceKobaraImaiCipherSpi$McElieceKobaraImai extends McElieceKobaraImaiCipherSpi
{

    public McElieceKobaraImaiCipherSpi$McElieceKobaraImai()
    {
