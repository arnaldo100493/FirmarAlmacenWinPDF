...
public static class McElieceFujisakiCipherSpi$McElieceFujisaki256 extends McElieceFujisakiCipherSpi
{

    public McElieceFujisakiCipherSpi$McElieceFujisaki256()
    {
