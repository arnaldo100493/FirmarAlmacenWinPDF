...
public static class McEliecePointchevalCipherSpi$McEliecePointcheval384 extends McEliecePointchevalCipherSpi
{

    public McEliecePointchevalCipherSpi$McEliecePointcheval384()
    {
