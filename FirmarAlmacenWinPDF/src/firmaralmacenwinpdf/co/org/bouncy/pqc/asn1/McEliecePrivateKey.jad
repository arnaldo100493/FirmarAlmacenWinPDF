...
// Source File Name:   McEliecePrivateKey.java
...
public class McEliecePrivateKey extends ASN1Object
{
    ...
    public McEliecePrivateKey(ASN1ObjectIdentifier oid, int n, int k, GF2mField field, PolynomialGF2mSmallM goppaPoly, GF2Matrix sInv, Permutation p1, 
