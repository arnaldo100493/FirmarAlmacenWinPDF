...
// Source File Name:   McEliecePrivateKeyParameters.java
...
public class McEliecePrivateKeyParameters extends McElieceKeyParameters
{
    ...
    public McEliecePrivateKeyParameters(String oid, int n, int k, GF2mField field, PolynomialGF2mSmallM goppaPoly, GF2Matrix sInv, Permutation p1, 
