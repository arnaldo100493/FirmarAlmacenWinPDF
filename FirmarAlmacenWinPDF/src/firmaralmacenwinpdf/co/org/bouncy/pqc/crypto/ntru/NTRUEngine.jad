...
// Source File Name:   NTRUEngine.java
...
//            NTRUEncryptionPublicKeyParameters, NTRUEncryptionPrivateKeyParameters, IndexGenerator, NTRUEncryptionParameters
    ...
    implements AsymmetricBlockCipher
{
    ...
    private byte[] encrypt(byte m[], NTRUEncryptionPublicKeyParameters pubKey)
    {
        ...
        if(l > maxLenBytes)
            throw new DataLengthException((new StringBuilder()).append("Message too long: ").append(l).append(">").append(maxLenBytes).toString());
...
label0:
        ...
        throws InvalidCipherTextException
    {
        ...
        if(cl > maxMsgLenBytes)
            throw new InvalidCipherTextException((new StringBuilder()).append("Message too long: ").append(cl).append(">").append(maxMsgLenBytes).toString());
        byte cm[] = new byte[cl];
