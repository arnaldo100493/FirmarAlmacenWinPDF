...
public class TeleTrusTNamedCurves
{
    ...
    {
        return getOID((new StringBuilder()).append("brainpoolP").append(curvesize).append(twisted ? "t" : "r").append("1").toString());
    }
