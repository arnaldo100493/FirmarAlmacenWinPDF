...
// Source File Name:   BCDSTU4145PrivateKey.java
    ...
    implements java.security.interfaces.ECPrivateKey, co.org.bouncy.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
    ...
    public BCDSTU4145PrivateKey(String algorithm, ECPrivateKeyParameters params, BCDSTU4145PublicKey pubKey, co.org.bouncy.jce.spec.ECParameterSpec spec)
    {
        this.algorithm = "DSTU4145";
        attrCarrier = new PKCS12BagAttributeCarrierImpl();
        ECDomainParameters dp = params.getParameters();
        ...
        throws IOException
    {
        ...
        if(params.isNamedCurve())
        {
            ...
            if(ecP == null)
            {
                ...
                ecSpec = new ECNamedCurveSpec(oid.getId(), ellipticCurve, new ECPoint(gParam.getG().getX().toBigInteger(), gParam.getG().getY().toBigInteger()), gParam.getN(), gParam.getH());
            } else
            {
