...
public static class EC$Mappings extends AsymmetricAlgorithmProvider
{
    ...
    public void configure(ConfigurableProvider provider)
    {
        ...
        registerOid(provider, X9ObjectIdentifiers.id_ecPublicKey, "EC", new co.org.bouncy.jcajce.provider.asymmetric.ec.i.EC());
        registerOid(provider, X9ObjectIdentifiers.dhSinglePass_stdDH_sha1kdf_scheme, "EC", new co.org.bouncy.jcajce.provider.asymmetric.ec.i.EC());
        registerOid(provider, X9ObjectIdentifiers.mqvSinglePass_sha1kdf_scheme, "ECMQV", new co.org.bouncy.jcajce.provider.asymmetric.ec.i.ECMQV());
