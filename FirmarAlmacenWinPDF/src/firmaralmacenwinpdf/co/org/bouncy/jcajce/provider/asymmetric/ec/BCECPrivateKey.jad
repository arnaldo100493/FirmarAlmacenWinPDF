...
// Source File Name:   BCECPrivateKey.java
    ...
    implements java.security.interfaces.ECPrivateKey, co.org.bouncy.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
    ...
    public BCECPrivateKey(String algorithm, ECPrivateKeyParameters params, BCECPublicKey pubKey, co.org.bouncy.jce.spec.ECParameterSpec spec, ProviderConfiguration configuration)
    {
        this.algorithm = "EC";
        attrCarrier = new PKCS12BagAttributeCarrierImpl();
        ECDomainParameters dp = params.getParameters();
