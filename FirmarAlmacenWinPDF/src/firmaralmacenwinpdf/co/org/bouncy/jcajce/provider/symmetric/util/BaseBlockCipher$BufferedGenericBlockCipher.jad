...
import co.org.bouncy.crypto.modes.CTSBlockCipher;
...
private static class BaseBlockCipher$BufferedGenericBlockCipher
    implements BaseBlockCipher.GenericBlockCipher
{
    ...
    BaseBlockCipher$BufferedGenericBlockCipher(BufferedBlockCipher cipher)
    {
        this.cipher = cipher;
    }

    BaseBlockCipher$BufferedGenericBlockCipher(BlockCipher cipher)
    {
        this.cipher = new PaddedBufferedBlockCipher(cipher);
    }

    BaseBlockCipher$BufferedGenericBlockCipher(BlockCipher cipher, BlockCipherPadding padding)
    {
