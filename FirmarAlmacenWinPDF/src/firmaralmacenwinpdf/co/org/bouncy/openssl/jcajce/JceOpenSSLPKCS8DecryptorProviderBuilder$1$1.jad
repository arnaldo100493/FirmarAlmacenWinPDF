...
class JceOpenSSLPKCS8DecryptorProviderBuilder$1$1
    implements InputDecryptor
{
    ...
    {
        return new CipherInputStream(encIn, val$cipher);
    }
    ...
    JceOpenSSLPKCS8DecryptorProviderBuilder$1$1()
    {
        this$1 = final__pcls1;
        val$algorithm = algorithmidentifier;
        val$cipher = Cipher.this;
        super();
    }

    // Unreferenced inner class co/org/bouncy/openssl/jcajce/JceOpenSSLPKCS8DecryptorProviderBuilder$1

/* anonymous class */
    class JceOpenSSLPKCS8DecryptorProviderBuilder._cls1
        implements InputDecryptorProvider
    {
            ...
            throws OperatorCreationException
        {
            try
            {
                ...
                return cipher. new JceOpenSSLPKCS8DecryptorProviderBuilder._cls1._cls1();
            }
            catch(IOException e)
            {
