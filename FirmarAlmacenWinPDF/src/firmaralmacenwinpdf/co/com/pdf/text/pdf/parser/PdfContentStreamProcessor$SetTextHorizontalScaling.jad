    ...
    implements ContentOperator
{
    ...
    public void invoke(PdfContentStreamProcessor processor, PdfLiteral operator, ArrayList operands)
    {
        ...
        PdfContentStreamProcessor.access$3700(processor).horizontalScaling = scale.floatValue() / 100F;
    }
    ...
    PdfContentStreamProcessor$SetTextHorizontalScaling(PdfContentStreamProcessor._cls1 x0)
    {
        this();
    }
}
